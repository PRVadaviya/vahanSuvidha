            ...
            <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                ...
                <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                    <div
                        ...
                        onClick={() => navigate('/equipment/aggricultural')}
                    ...
                    <div
                        className="group relative border-2 border-black rounded-md"
                        onClick={() => navigate('/equipment/construction')}
                        style={{ cursor: 'pointer' }}>
                    ...
                    <div
                        className="group relative border-2 border-black rounded-md"
                        onClick={() => navigate('/equipment/transportationEquipment')}
                        style={{ cursor: 'pointer' }}>
                    ...
                    <div
                        className="group relative border-2 border-black rounded-md"
                        onClick={() => navigate('/equipment/medicalequipment')}
                        style={{ cursor: 'pointer' }}>
