...
import { CAR_DATA } from './ShippingContainersData'
import './shippingContainers.css'
import HeaderCard from '../HeaderCard'

function ShippingContainersDisplay() {
    return (
        <div>
            <HeaderCard />
            <div className="app-container">
                <h1>ShippingContainers</h1>
...
export default ShippingContainersDisplay
