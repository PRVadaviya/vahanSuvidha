...
import CAR_DATA from "./ExcavatorBucketData";
import './excavatorBucket.css'
import HeaderCard from '../HeaderCard'

const ExcavatorBucketDisplay = () => {
  return (
    <div>
      <HeaderCard />
      <div className="app-container">
        <h1>ExcavatorBucket</h1>
...
export default ExcavatorBucketDisplay;
