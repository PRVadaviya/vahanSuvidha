...
import { CAR_DATA } from './HydrolicBreakerData'
import './HydrolicBreaker.css'
import HeaderCard from '../HeaderCard'

function HydrolicBreakerDisplay() {
    return (
        <div>
            <HeaderCard />
            <div className="app-container">
                <h1>HydrolicBreaker</h1>
...
export default HydrolicBreakerDisplay
