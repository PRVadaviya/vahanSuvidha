...
public class Harvester {
     ...
     @ManyToOne
     @JoinColumn(name = "agricultureVehicleId")
     @JsonBackReference
     private AgricultureVehicle agricultureVehicle;
     ...
     public AgricultureVehicle getAgricultureVehicle() {
          return agricultureVehicle;
     }
     public void setAgricultureVehicle(AgricultureVehicle agricultureVehicle) {
