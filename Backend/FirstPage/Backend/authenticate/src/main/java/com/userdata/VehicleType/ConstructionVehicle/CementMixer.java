...
public class CementMixer {
     ...
     @ManyToOne
     @JoinColumn(name = "constructionVehicleId")
     @JsonBackReference
     private ConstructionVehicle constructionVehicle;
     ...
     public ConstructionVehicle getConstructionVehicle() {
          return constructionVehicle;
     }
     public void setConstructionVehicle(ConstructionVehicle constructionVehicle) {
          this.constructionVehicle = constructionVehicle;
     }
